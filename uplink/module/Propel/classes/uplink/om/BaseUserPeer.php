...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'FirstName', 'LastName', 'Password', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'firstName', 'lastName', 'password', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::FIRST_NAME, UserPeer::LAST_NAME, UserPeer::PASSWORD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'FIRST_NAME', 'LAST_NAME', 'PASSWORD', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'first_name', 'last_name', 'password', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'FirstName' => 2, 'LastName' => 3, 'Password' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'firstName' => 2, 'lastName' => 3, 'password' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::FIRST_NAME => 2, UserPeer::LAST_NAME => 3, UserPeer::PASSWORD => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'FIRST_NAME' => 2, 'LAST_NAME' => 3, 'PASSWORD' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'first_name' => 2, 'last_name' => 3, 'password' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        // Invalidate objects in RightsPeer instance pool,
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related Rights objects
            $criteria = new Criteria(RightsPeer::DATABASE_NAME);

            $criteria->add(RightsPeer::USER_ID, $obj->getId());
            $affectedRows += RightsPeer::doDelete($criteria, $con);
        }
